        ...
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            <div className="bg-white shadow-lg p-2 sm:p-6 w-full max-w-lg md:max-w-3xl rounded-lg">
                <div className="flex flex-col sm:flex-row justify-between mb-4 gap-2 sm:gap-0 px-2 sm:px-0">
                    ...
                    <Link to="/login" className="text-gray-600 hover:text-black mt-2 sm:mt-0 text-sm sm:text-base">login</Link>
                </div>
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-3 px-2 sm:px-0">
                    ...
                    <input type="text" placeholder="type → tailor, fashion designer, embroiderer, crochet etc" className="p-2 bg-[#D9D9D9] w-full focus:outline-none focus:ring-0 rounded" />
                    <input type="password" placeholder="password" className="p-2 bg-[#D9D9D9] w-full focus:outline-none focus:ring-0 rounded" />
                    <input type="text" placeholder="experience in years" className="p-2 bg-[#D9D9D9] w-full focus:outline-none focus:ring-0 rounded" />
                    <textarea placeholder="description" className="p-2 bg-[#D9D9D9] w-full md:col-span-1 h-24 focus:outline-none focus:ring-0 rounded"></textarea>
                    <input type="file" className="p-2 bg-[#D9D9D9] w-full md:col-span-1 focus:outline-none focus:ring-0 rounded" />
