...
function ForgetPasswordPage() {
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="text-gray-400 text-base md:text-lg p-2 pl-4">forget password page</div>
      <div className="bg-white m-2 md:m-4 p-0 md:p-8 min-h-[80vh] flex flex-col justify-between">
        ...
        <main className="flex flex-1 flex-col items-center justify-center w-full">
          <h2 className="text-xl md:text-2xl font-normal mb-6 md:mb-8 mt-4">Forget Password</h2>
          <form className="w-full max-w-xs md:max-w-md flex flex-col items-center gap-3 md:gap-4">
            ...
            <div className="w-full flex flex-col gap-2">
              <div className="flex justify-end">
                <Link to="/login" className="text-black text-xs md:text-sm hover:underline">Back to login</Link>
              </div>
            </div>
            <button
              type="submit"
